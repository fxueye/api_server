...
class Api_model extends MY_Model {
	...
	public function get_top100(){
		return $this->dtkSdk->get_data(DtkSdk::$top,"top100");
	}
	public function get_paoliang(){
		return $this->dtkSdk->get_data(DtkSdk::$top,"paoliang");
	}
	public function get_good($id){
		return $this->dtkSdk->get_good($id);
	}
